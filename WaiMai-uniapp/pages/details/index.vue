  ...
  <view>
    ...
    <view class="order_content orderDetail">
      <view class="order_content_box" scroll-y="true" scroll-top="0rpx">
        <!-- 支付状态 -->
        <status ref="status" :timeout="timeout" :orderDetailsData="orderDetailsData" :rocallTime="rocallTime" @handleCancel="handleCancel"
        ...
        <view class="box contactMerchant">
          <button @click="handlePhone('bottom', shopPhone)">
