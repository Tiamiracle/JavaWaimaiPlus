			...
			<view class="contion">
				<view class="orderPay">
					<view>
						...
						<view v-else>支付剩余时间<text>{{ rocallTime }}</text></view>
					</view>
					<view class="money">￥<text>{{ orderDataInfo.orderAmount }}</text></view>
					...
					<view class="example-body">
						<radio-group class="uni-list" @change="styleChange">
							<view class="uni-list-item">
								<view class="uni-list-item__container" v-for="(item, index) in payMethodList"
									:key="item">
                      ...
                      item
									...
									<view class="uni-list-item__extra">
										<radio :value="item" color="#FFC200" :checked="index == activeRadio"
											class="radioIcon" />
									</view>
								</view>
							</view>
