...
<template>
  <view class="box address_order">
    ...
    <view class="edit" @click="goEdit">
      ...
      <text class="edit_word">修改信息</text>
      <image class="to_right" src="../../../static/toRight.png" mode=""></image>
    </view>
    <!-- 退出登录 -->
    <view class="logout" v-if="userId"  @click="logout">
      <image class="location" src="../../../static/logout.png"></image>
      <text class="logout_word">退出登录</text>
      <image class="to_right" src="../../../static/toRight.png" mode=""></image>
    </view>
  </view>
</template>
