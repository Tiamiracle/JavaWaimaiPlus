  ...
  <div class="container">
    ...
    <div class="overviewBox">
      <ul>
        <li>
          <p class="tit">营业额</p>
          <p class="num">¥ {{ formatToFixed(overviewData.turnover) }}</p>
        </li>
        <li>
          <p class="tit">有效订单</p>
        ...
        <li>
          <p class="tit">平均客单价</p>
          <p class="num">¥ {{ formatToFixed(overviewData.unitPrice) }}</p>
        </li>
...
import { formatToFixed } from '@/utils/common'
@Component({
  name: 'Overview',
})
export default class extends Vue {
  @Prop() private overviewData!: any
  private formatToFixed = formatToFixed
  get days() {
    return getday()
  }
}
